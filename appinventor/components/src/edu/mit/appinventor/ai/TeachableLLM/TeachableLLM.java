...
/**
 * TeachableLLM Extension, based on the Teachable Machine extension
 * 
 * @author richard134x@gmail.com (Richard A. Xiong)
 *
 */
package edu.mit.appinventor.ai.TeachableLLM;
...
@DesignerComponent(version = 1,
    description = "The TeachableLLM extension allows for ChatBot usage with RAG using MeMemo and a supplementary website.",
    category = ComponentCategory.EXTENSION, nonVisible = true, iconName = "teachablellm.png")
      ...
      public WebResourceResponse shouldInterceptRequest(WebView view, WebResourceRequest request) {
        ...
        try {
          ...
          if (path.startsWith("TeachableLLM")) {
            file = form.openAssetForExtension(TeachableLLM.this, path);
          } else {
